...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        # ==========Img1=========
        img1=Image.open(r"C:\Users\HP LAPTOP\Desktop\Hotel management system\images\hotel1.png")
        ...
        button_frame.place(x=0,y=60,width=228,height=190)
        ...
        details_btn=Button(button_frame,command=self.details_room,text="DETAILS",width=22,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
        details_btn.grid(row=2,column=0,pady=1)
        
        report_btn=Button(button_frame,text="REPORT",width=22,font=("times new roman",14,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
        ...
        #======right side image======
        img3=Image.open(r"C:\Users\HP LAPTOP\Desktop\Hotel management system\images\slide3.jpg")
        ...
        #=======Down images=======
        img4=Image.open(r"C:\Users\HP LAPTOP\Desktop\Hotel management system\images\myh.jpg")
        img4=img4.resize((230,210),Image.Resampling.LANCZOS)
        self.photoimg4=ImageTk.PhotoImage(img4)
        lblimg1=Label(main_frame,image=self.photoimg4,bd=4,relief=RIDGE)
        lblimg1.place(x=0,y=250,width=230,height=210)
        
        img5=Image.open(r"C:\Users\HP LAPTOP\Desktop\Hotel management system\images\khana.jpg")
        img5=img5.resize((420,190),Image.Resampling.LANCZOS)
