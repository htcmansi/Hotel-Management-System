...
class Roombooking:
    def __init__(self,root):
        ...
        enrty_contact=ttk.Entry(labelframeleft,textvariable=self.var_contact,width=20,font=("arial",13,"bold"))
        enrty_contact.grid(row=0,column=1,sticky=W)
        ...
        img3=Image.open(r"C:\Users\HP LAPTOP\Desktop\Hotel management system\images\bed.jpg")
